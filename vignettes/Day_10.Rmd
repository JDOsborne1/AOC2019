...
```{r Get a list of asteroid coords}
test_input <- ".#..#
.....
#####
....#
...
```{r for a particular coord get the vectors}
...
asteroid_list %>% 
  ...
  unnest(cols = c(View.Counts)) %>% View(
...
.#...#....#...##..##.#.#......#
#..###.....##.#.......#.##...##"%>% 
  day10InputParser() -> new_ast_list


new_ast_list%>% 
  mutate(View.Counts = map(coords, day10AsteroidViewCount, new_ast_list)) %>% 
